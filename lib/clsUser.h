...
private:
	...
	static stLoginRegisterRecord _ConvertLoginRegisterLineRecord(string Line, string Seperator = "#//#")
	{
		...
		LoginRegisterRecord.Password = clsUtil::DecryptWord(LoginRegisterDataLine[2]);
	...
	string _PrepareLogInRecord(string Seperator = "#//#")
	{
		...
		LoginRecord += clsUtil::EncryptWord(GetPassword()) + Seperator;
    ...
    static clsUser _ConvertLinetoUserObject(string Line, string Seperator = "#//#")
	{
		...
		return clsUser(enMode::UpdateMode, vUserData[0], vUserData[1], vUserData[2], vUserData[3], vUserData[4], clsUtil::DecryptWord(vUserData[5]), stoi(vUserData[6]));
	}
	...
	static string _ConverUserObjectToLine(clsUser User, string Seperator = "#//#")
	{
		...
		UserRecord += clsUtil::EncryptWord(User.GetPassword()) + Seperator;
	...
	{
		fstream MyFile;
		MyFile.open("db/Users.txt", ios::out);//overwrite
...
public:
	...
	static vector<stLoginRegisterRecord> GetLoginRegisterList()
	{
		...
		if (MyFile.is_open())
		{
			...
			while (getline(MyFile, Line))
			{
				LoginRegisterRecord = _ConvertLoginRegisterLineRecord(Line);
